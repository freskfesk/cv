...
\begin{itemize} \itemsep -2pt % Reduce space between items
	...
	\item Kodespråk hovedsaklig C, men også Python og C#
\end{itemize}
...
\begin{itemize}\itemsep -2pt  % Reduce space between items 
	...
	\item Oppfant gode algoritmer for riktig utnyttelse av tilgjengelig båndbredde 
	\item Implementeringen og testing av algoritmene
\end{itemize}
