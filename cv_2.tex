...
Overvåkningsprogram som består av sensorer, embedded feltenheter, server, database og klient. Jeg har vært med på utvikling av server og klient de siste 16 månedene. 
\begin{itemize}\itemsep -2pt   % Reduce space between items
...
\textbf{\emph{Utvikling av UI for testutstyr}}\\
